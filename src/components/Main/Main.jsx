    ...
    <>
      <div className="main">
        ...
        <div className="parent">
          ...
          <div className="div5"><a href="/mouse"><img src="/mouse/mouse1.jpg" className="mouse-main" /></a></div>
          <div className="div6">6</div>
          <div className="div7">
            <h1 className="hi">Hi!</h1>
            <h2 className="ryan">My name is Ryan Parker.</h2>
          </div>
          <div className="div8"><h3 className="creative">I&apos;m a creative software developer located in Vancouver, WA.</h3></div>
          <div className="div9"><h3 className="mousecode">You can usually find me writing code with Mouse.</h3></div>
          <div className="div10">10</div>
          <div className="div11">11</div>
          <div className="div12">12</div>
          <div className="div13">
            <a href="http://github.com/ryan-j-parker" target="_blank" rel="noreferrer"><img src="/github-icon-white.png" className="icon" /></a>
            <a href="http://linkedin.com/in/ryanparkerdev" target="_blank" rel="noreferrer"><img src="/linkedin-icon.png" className="icon" /></a>
            <a href="http://twitter.com/ryanparkerdev" target="_blank" rel="noreferrer"><img src="/twitter-icon.png" className="icon" /></a>
          </div>
        </div>
      </div>
    </>
